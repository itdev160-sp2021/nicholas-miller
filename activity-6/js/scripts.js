...
var data =[
    {
        ...
        user:'Nick',
        message: 'Wanna go to the Bucks game?'
    },

    {
        type: messageType.in,
        user:'James',
        message: 'Hi James, Sounds good!'
    },

    {
        type: messageType.out,
        user:'Nick',
        message: "Ok, I have tickets, lets go!"
    }
];
...
function addMessageHandler(event){
    ...
    // Determine message type and set messages variables accordingly
